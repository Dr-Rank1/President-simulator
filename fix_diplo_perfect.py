...
old_vis = """                    selectedRival?.let { rival ->"""
new_vis = """                    item { selectedRival?.let { rival ->"""
content = content.replace(old_vis, new_vis)

old_vis_end = """                            onDeclareWar = { goal -> viewModel.declareWar(rival.id, goal) },
                        )
                    }
                }
...
new_vis_end = """                            onDeclareWar = { goal -> viewModel.declareWar(rival.id, goal) },
                        )
                    } }
                }
