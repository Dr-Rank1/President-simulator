...
# Replace the Column and contents
                        ...
                        item {
                            RivalActionPanel(
                                ...
                                onSendAid = { 
                                    ...
                                    Toast.makeText(context, "Foreign aid sent to ${rival.name}.", Toast.LENGTH_SHORT).show()
                                },
                                onStateVisit = { 
                                ...
                                onNegotiateNonAggression = { 
                                    ...
                                    Toast.makeText(context, "Non-aggression pact signed.", Toast.LENGTH_SHORT).show()
                                },
                                onFormAlliance = { 
